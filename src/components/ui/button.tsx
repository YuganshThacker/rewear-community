  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accent: "bg-gradient-warm text-accent-foreground hover:bg-accent-hover shadow-soft hover:shadow-medium hover:scale-105",
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-strong hover:scale-105 font-semibold",
        success: "bg-success text-primary-foreground hover:bg-success/90 shadow-soft hover:shadow-medium",
      },
      size: {
